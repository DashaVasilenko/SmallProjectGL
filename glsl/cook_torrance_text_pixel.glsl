// кук торренc. Все векторы переводяться в пространство камеры, и дальнейшие вычисления ведутся в нем
...
void main() {
    outColor = texture(Texture, outTexCoord)*vec4(CookTorrance(outNormal, vec3(0.0f, 1.0f, 0.0f), -outEye, 0.1), 1.0);
}